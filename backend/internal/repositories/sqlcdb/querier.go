...
type Querier interface {
	...
	CancelPendingReservationsForBook(ctx context.Context, bookID pgtype.UUID) error
	...
	CreateDamageLostIncident(ctx context.Context, arg CreateDamageLostIncidentParams) (DamageLostIncident, error)
	CreateFine(ctx context.Context, arg CreateFineParams) (Fine, error)
	CreateFineForIncident(ctx context.Context, arg CreateFineForIncidentParams) (Fine, error)
	...
	GetCategoryUsageByGradeLevel(ctx context.Context) ([]GetCategoryUsageByGradeLevelRow, error)
	GetCirculationStatusDistribution(ctx context.Context) ([]GetCirculationStatusDistributionRow, error)
	...
	GetDamageLostStats(ctx context.Context) (GetDamageLostStatsRow, error)
	// Dashboard Statistics
	GetDashboardStats(ctx context.Context) (GetDashboardStatsRow, error)
	GetDashboardStatsEnhanced(ctx context.Context) (GetDashboardStatsEnhancedRow, error)
	GetFineByID(ctx context.Context, id uuid.UUID) (GetFineByIDRow, error)
	GetFinesByGradeLevel(ctx context.Context) ([]GetFinesByGradeLevelRow, error)
	...
	GetLoansByGradeLevel(ctx context.Context) ([]GetLoansByGradeLevelRow, error)
	// Monthly trends (last 6 months)
	GetMonthlyTrends(ctx context.Context) ([]GetMonthlyTrendsRow, error)
	GetMonthlyTrendsByYear(ctx context.Context) ([]GetMonthlyTrendsByYearRow, error)
	GetNextCopyNumber(ctx context.Context, bookID pgtype.UUID) (int32, error)
	GetNextPendingReservation(ctx context.Context, bookID pgtype.UUID) (BookRequest, error)
	GetOverdueByGradeLevel(ctx context.Context) ([]GetOverdueByGradeLevelRow, error)
	...
	GetReservationQueuePosition(ctx context.Context, arg GetReservationQueuePositionParams) (pgtype.Int4, error)
	...
	GetStudentsByGradeLevel(ctx context.Context) ([]GetStudentsByGradeLevelRow, error)
	// Top borrowed books
	GetTopBorrowedBooks(ctx context.Context) ([]GetTopBorrowedBooksRow, error)
	GetTopBorrowedByGradeLevel(ctx context.Context) ([]GetTopBorrowedByGradeLevelRow, error)
	...
	GetTransactionByReceiptNo(ctx context.Context, receiptNo pgtype.Text) (Transaction, error)
	// Transaction status distribution
	GetTransactionStatusDistribution(ctx context.Context) ([]GetTransactionStatusDistributionRow, error)
	GetTransactionWithCirculationStatus(ctx context.Context, id uuid.UUID) (GetTransactionWithCirculationStatusRow, error)
	...
	ListDamageLostIncidents(ctx context.Context) ([]ListDamageLostIncidentsRow, error)
	...
	MarkTransactionDamaged(ctx context.Context, arg MarkTransactionDamagedParams) (Transaction, error)
	MarkTransactionLost(ctx context.Context, arg MarkTransactionLostParams) (Transaction, error)
	...
	UpdateReservationQueuePositions(ctx context.Context, arg UpdateReservationQueuePositionsParams) error
	...
	UpdateTransactionReturnWithStatus(ctx context.Context, arg UpdateTransactionReturnWithStatusParams) (Transaction, error)
